...
import { Alert, AppBar, Button, Card, Snackbar, TextField, Toolbar, Typography } from "@mui/material";
            ...
            <center>
                <Card className={classes.card}>
                    ...
                    <form onSubmit={handleSubmit} id="addForm">
                        <TextField label="Subject" name="subject" id="outlined-size-small" size="small" type="text" onChange={handleChange} multiline rows={2} />
                        <br />
                        <br />
                        <TextField label="Question" name="question" id="outlined-size-small" size="small" type="text" onChange={handleChange} multiline rows={2} />
                        <br />
                        <br />
                        <TextField label="Answer" name="answer" id="outlined-size-small" size="small" type="text" onChange={handleChange} multiline rows={2} />
                        <br />
                        <br />
